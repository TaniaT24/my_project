...
Widget _buildPopupDialog4(BuildContext context) {
  return new AlertDialog(
    ...
    content: new Column(
      ...
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Text("Invitatie la Vals de Mihail Drumes,Enigma Otiliei de George Calinescu,Patul lui Procust de Camil Petrescu "),
      ],
    ),
    actions: <Widget>[
      new TextButton(
         ...
         child:   Wrap(children:[  Text(          
            ...
            showDialog(
              ...
              builder: (BuildContext context) => _buildPopupDialog(context),
                  ...
                  child:Text('Pride and Prejudice ',
